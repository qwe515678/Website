 ...
 export default async function Job() {
    ...
    return (
        <section className='mt-32'>
          ...
          <div
            key={data._id}
            className="flex items-start lg:gap-x-6 gap-x-4 max-w-2xl relative before:absolute before:bottom-0 before:top-[4.5rem] before:left-7 before:w-[1px]  before:bg-zinc-800"
          >
            <a
              href={data.url}
